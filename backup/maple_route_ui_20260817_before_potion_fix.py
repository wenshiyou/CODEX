...
class MinimapRouteRecorder:
    ...
    def _is_bar_blank_at(self, frame, bar, pct, color_type):
        ...
        color_type='hp': 填充=红(R>150), 'mp': 填充=蓝(B>200)
        检测框: 2px宽 x 8px高（竖长条），中心在pct%位置"""
            ...
            for dy in range(0, 9):
                ...
                if 0 <= xx < frame.shape[1] and 0 <= yy < frame.shape[0]:
                    ...
                    if color_type == "hp":
                        ...
                        if int(b) > 200:
                            filled += 1
        return total > 0 and filled < total // 2
    ...
    def _check_auto_potion(self):
        ...
        if frame is not None:
            ...
            if self._hp_bar:
                ...
                cv2.rectangle(dbg, (cx - 1, hy), (cx + 1, hy + 8), (0, 0, 0), 1)
            ...
            if self._mp_bar:
                ...
                cv2.rectangle(dbg, (cx - 1, my), (cx + 1, my + 8), (0, 0, 0), 1)
